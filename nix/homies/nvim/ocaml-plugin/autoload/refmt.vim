...
function! refmt#callRefmtProgramForReadyProject(inLines, ext)
  let pathTo = substitute(system('which refmt'),'\n$','','''')
  if v:shell_error != 0
...
function! refmt#Refmt(...)
  ...
  let out = refmt#callRefmtProgramForReadyProject(inLines, ext)
